...
<img width="500" height="456" alt="Image" src="https://github.com/user-attachments/assets/c642838b-ff34-497c-b402-d9b36029ac71" /><br>
...
$$
f(\mathbf{h}) = \mathbb{I} \left[ \cos(\mathbf{h}, \mathbf{c}_{\text{hate}}) > \theta \lor \cos(\mathbf{h}, \mathbf{c}_{\text{legal}}) > \theta \right]
$$
